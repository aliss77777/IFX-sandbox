...
from typing import Annotated, Any, List, Optional, Sequence, Tuple, TypedDict, Union
...
async def call_model(
    ...
    response = await llm_with_tools.with_config(callbacks=[handler]).ainvoke(
        prompt.llm_prompt, stream=True
    )
